...
/**
 * @openapi
 * /api/carabineros/validar-rut:
 *   post:
 *     summary: Validar RUT de Carabinero (Estándar)
 *     description: Endpoint estandarizado para validación. Valida si el RUT pertenece a Carabineros. Si es válido, crea/actualiza el pasajero y lo asocia al convenio.
 *     tags: [Carabineros]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *         description: Error interno o de configuración.
 */
router.post('/validar-rut', authMiddleware, carabinerosController.validar);
