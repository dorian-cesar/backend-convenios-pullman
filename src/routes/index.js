...
const colocoloRoutes = require('./colocolo.routes');
...
const invalidacionesRoutes = require('./invalidaciones.routes');
...
router.use('/integraciones', colocoloRoutes);
...
router.use('/invalidaciones', invalidacionesRoutes);
