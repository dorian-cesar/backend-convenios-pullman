...
const crearConvenio = {
    body: Joi.object().keys({
        ...
        fecha_inicio_inscripcion: Joi.date().iso().allow(null).optional(),
        fecha_fin_inscripcion: Joi.date().iso().allow(null).optional(),
        inscripcion_activa: Joi.boolean().default(false),
...
const actualizarConvenio = {
    ...
    body: Joi.object().keys({
        ...
        fecha_inicio_inscripcion: Joi.date().iso().allow(null),
        fecha_fin_inscripcion: Joi.date().iso().allow(null),
        inscripcion_activa: Joi.boolean(),
...
const validarCodigoConvenio = {
    ...
    body: Joi.object().keys({
        convenio_id: Joi.number().integer().optional(),
