      ...
      schemas: {
        ...
        CrearConvenio: {
          ...
          properties: {
            ...
            tipo_alcance: { type: 'string', enum: ['Global', 'Rutas Especificas'], default: 'Global', description: 'Si es "Rutas Especificas", se requiere configurar rutas y se fuerza tipo_descuento a "Tarifa Plana".' },
            tipo_descuento: { type: 'string', enum: ['Porcentaje', 'Monto Fijo', 'Tarifa Plana'], default: 'Porcentaje', description: 'Obligatorio "Tarifa Plana" si el alcance es por rutas (Rutas Especificas).' },
            valor_descuento: { type: 'number', example: 10000, description: 'Monto del descuento o Porcentaje. Si es Tarifa Plana, se ignora (se usa precio_solo_ida).' },
            endpoint: { type: 'string', example: "/api/integraciones/araucana/validar" },
