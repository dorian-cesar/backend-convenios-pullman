...
// EMPRESA -> API_REGISTRO (1:N)
Empresa.hasMany(ApiRegistro, { foreignKey: 'empresa_id', as: 'apisRegistro', onDelete: 'NO ACTION' });
ApiRegistro.belongsTo(Empresa, { foreignKey: 'empresa_id', as: 'empresa', onDelete: 'NO ACTION' });
